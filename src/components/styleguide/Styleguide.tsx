...
export const Styleguide = () => {
  return (
    <VStack maxW={800} mx='auto' pt={40}>
        <Box w='100%' p={6} border='1px solid' borderColor='whiteAlpha.300'>
          <Heading as='h2' size='lg' color='white' mb={2}>Buttons</Heading>
        ...
        <Box w='100%' p={6} border='1px solid' borderColor='whiteAlpha.300'>
          <Heading as='h2' size='lg' color='white' mb={2}>Thumb Cards</Heading>
        ...
        <Box w='100%' p={6} border='1px solid' borderColor='whiteAlpha.300'>
          <Heading as='h2' size='lg' color='white' mb={2}>Battle Cards</Heading>
