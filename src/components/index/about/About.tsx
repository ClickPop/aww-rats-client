    ...
    <div className='bg-light overflow-hidden'>
      ...
      <div className='grid md:grid-cols-3 content-center max-w-4xl mx-auto text-slate pt-16 pb-24'>
        <div className='md:col-span-2 p-4'>
          ...
          <p className='my-4'>
            They&apos;re a pack of programmatically generated NFT rats on the
            Matic blockchain. We chose Matic because it has extraordinarily low
            gas fees and uses significantly less electricity than the ethereum
            mainnet.
          </p>
          <p className='my-4'>
            Each rat is unique and randomly generated with a ton of different
            colors, clothes, accessories, and attributes.
          </p>
          <p className='my-4'>
            Owning a rat gives you access to tools to build your own project
            (coming soon), educational resources and tutorials, and a community
            of other creators.
          </p>
        </div>
        <Image
