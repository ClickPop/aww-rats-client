    ...
    <div className='w-full bg-dark text-tan'>
      <div className='flex flex-col max-w-xl px-4 mx-auto py-20'>
        <div className='text-lg'>
          <h2 className='mb-4 text-4xl font-bold'>We are aww about Community.</h2>
          <p className='mb-8'>
          ...
          <p className='mb-8'>
            ...
            every Monday and Wednesday at 9PM ET, at minimum. This is our chance to give development updates, play games with our community, and do some drawwing on stream.
            In fact, some of the items you see in these Aww, Rats! NFTs came from suggestions from chatters in our earliest live streams!
          </p>
          <h3 className='mb-4 text-2xl font-bold'>Rat Races for custom 1/1 NFTs</h3>
          <p className='mb-8'>
