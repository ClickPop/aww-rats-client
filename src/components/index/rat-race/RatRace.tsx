    ...
    <div className="w-full bg-dark text-tan">
      <div className="flex flex-col max-w-xl px-4 mx-auto py-16">
        ...
        <div className="text-lg">
          ...
          <h2 className="mb-4 text-4xl font-bold">What can I win?</h2>
          ...
          <p className="mb-8"><Link href="/ratrace" className="underline font-semibold">Check out information about the next competition.</Link></p>
          <h2 className="mb-4 text-4xl font-bold">How can I compete?.</h2>
          ...
          <h2 className="mb-4 text-4xl font-bold">Where are the competitions held?</h2>
          <p className="mb-2">Rat Races will be <Link href="https://twitch.tv/awwratspack" className="underline font-semibold">streamed live on Twitch</Link> so you can cheer your favorite rat on.</p>
          <p className="mb-8">Whether your own little Rat is competing, or if you just want to spectate and catch the competition, it&apos;s a great way to catch up with everybody else in the Rat Pack.</p>
          <h2 className="mb-4 text-4xl font-bold">Do I need a Rat to join?</h2>
          <p className="mb-8">
