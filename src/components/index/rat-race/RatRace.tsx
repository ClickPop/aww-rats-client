    ...
    <div className="w-full bg-dark text-tan">
      <div className="flex flex-col max-w-xl px-4 mx-auto py-16">
        ...
        <div className="text-lg">
          ...
          <h3 className="mb-4 text-3xl font-bold">What can I win?</h3>
          ...
          <h3 className="mb-4 text-3xl font-bold">How can I compete?.</h3>
          ...
          <h3 className="mb-4 text-3xl font-bold">Where are the competitions held?</h3>
          ...
          <h3 className="mb-4 text-3xl font-bold">Do I need a Rat to join?</h3>
          <p className="mb-8">
